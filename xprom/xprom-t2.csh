...
awk '/Correlation energy      =/ {printf "%14.6f\n",$4}' < $1 >> corr
cat neq k p ee eec eexc own net int eadd eeff corr > mono
rm neq k p ee eec eexc own net int eadd eeff corr 
rm -f int 
...
awk '/Interaction with atom/ {getline;getline;getline;getline;getline;getline;getline;getline;getline;printf "%14.6f\n",$4 }' < $1 >> int
