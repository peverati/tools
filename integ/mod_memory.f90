...
module mod_memory
  ...
  interface free
    ...
    module procedure dfree4
    module procedure dfree6
  ...
  interface alloc
    ...
    module procedure dalloc4
    module procedure dalloc6
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine dalloc4(file__, array__, array, size_t1, size_t2, size_t3, size_t4, debug)

    implicit none
    integer(kind=i4), intent(in) :: size_t1, size_t2, size_t3, size_t4
    character(len=*), intent(in) :: file__, array__
    real(kind=rp), allocatable, dimension(:,:,:,:) :: array
    logical, optional :: debug
    ...
    if (allocated(array)) then
      ...
      allocate (array(size_t1,size_t2,size_t3,size_t4), stat=ier) 
      if (ier.ne.0) then
        call ferror(trim(file__), 'error allocating '//trim(array__), faterr)
      end if
      array = 0.0_rp
    end if
    mallocated = mallocated + size_t1*size_t2*size_t3*size_t4
  ...
  subroutine dalloc6(file__, array__, array, size_t1, size_t2, size_t3, size_t4, size_t5, size_t6, debug)

    implicit none
    integer(kind=i4), intent(in) :: size_t1, size_t2, size_t3, size_t4, size_t5, size_t6  
    character(len=*), intent(in) :: file__, array__
    real(kind=rp), allocatable, dimension(:,:,:,:,:,:) :: array
    logical, optional :: debug
    ...
    if (allocated(array)) then
      ...
      allocate (array(size_t1,size_t2,size_t3,size_t4,size_t5,size_t6), stat=ier) 
      if (ier.ne.0) then
        call ferror(trim(file__), 'error allocating '//trim(array__), faterr)
      end if
      array = 0.0_rp
    end if
    mallocated = mallocated + size_t1*size_t2*size_t3*size_t4*size_t5*size_t6
  ...
  subroutine dfree4(file__, array__, array)
  ...
  subroutine dfree6(file__, array__, array)
